...
while continue_playing:
    ...
    if Another_card == "y":
        ...
        results+=random_card
        print(f"Your score: {results}")
        random_comp_cards = random.choice(cards)
        computer_card.append(random_comp_cards)
        results_comp+=random_comp_cards
        print(f"Computer cards are: {computer_card}")
        print(f"Computer score: {results_comp}")
    elif Another_card == "n":
        continue_playing = False
        print(f"Your cards are: {My_cards}, final score: {results}")
        print(f"Computer cards are: {computer_card}, final score: {results_comp}")